...
public class AuthorServletTest extends TestSetup {
...
//    PrintWriter writer = mock(PrintWriter.class);
    ...
    @Test
    public void doAddTest () throws IOException, SQLException, NoSuchEntityException {
        when(response.getWriter()).thenReturn(writer);
        when(request.getParameter("action")).thenReturn("add");
    ...
    @Test
    public void doUpdateTestException () throws IOException, SQLException, NoSuchEntityException {
        when(response.getWriter()).thenReturn(writer);
    ...
    @Test
    public void doAUpdatetTest () throws IOException, SQLException, NoSuchEntityException {
        when(response.getWriter()).thenReturn(writer);
        when(request.getParameter("action")).thenReturn("update");
        when(request.getParameter("id")).thenReturn("14");
        when(request.getParameter("name")).thenReturn("Максим Горький");
